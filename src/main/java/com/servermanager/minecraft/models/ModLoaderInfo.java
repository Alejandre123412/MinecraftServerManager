...
/**
 * Información detallada sobre un Mod Loader para una versión específica de Minecraft.
 *
...
public class ModLoaderInfo {
    /**
     * Nombre del loader, por ejemplo "Forge".
     */
    private final String loaderName;

    /**
     * Versión de Minecraft a la que corresponde este loader, por ejemplo "1.21.1".
     */
    ...
    /**
     * Constructor para crear una instancia de ModLoaderInfo.
     *
     ...
     */
    public ModLoaderInfo(String loaderName, String mcVersion, List<String> versions, String recommended, String latest) {
